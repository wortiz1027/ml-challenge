...
import co.com.merdadolibre.challenge.exceptions.PositionNotFoundException;
...
public class ProcessData implements IData {
    ...
    public Response processSatellitesData(Request data) {
        ...
        if (position == null) throw new PositionNotFoundException("Position not found...");
    ...
    private float[] build(Request data) {
        int index = 0;
